> **Heads up!** I am looking for a second maintainer or someone who is willing to takeover the project entirely as I am lack time to work on this project as well as a lack of motivation. I have started focussing on C++ and JavaScript more than C# as it is becoming less popular in the current jobmarket. In my area less and less jobs are available as .Net developer so as a programmer I too feel the need to start shifting away from C# and start focussing at other languages and frameworks if I ever hope to stay relevant. Nevertheless I also feel responsible towards you, the user, for delivering a good quality library so for that reason I prefer to pass ownership or have someone else help me out.
